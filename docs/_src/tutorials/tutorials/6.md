...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/deepset-ai/haystack/blob/master/tutorials/Tutorial6_Better_Retrieval_via_EmbeddingRetrieval.ipynb)
...
**Pros**: Captures semantic similarity instead of "word matches" (e.g. synonyms, related topics ...)
...
In this Tutorial, we use an `EmbeddingRetriever` with a style of models called [Sentence Transformers](https://www.sbert.net/index.html).

These models are trained to embed similar sentences near to each other in a shared embedding space.
...
*Use this* [link](https://colab.research.google.com/github/deepset-ai/haystack/blob/master/tutorials/Tutorial6_Better_Retrieval_via_EmbeddingRetrieval.ipynb) *to open the notebook in Google Colab.*
...
**Here:** We use a `EmbeddingRetriever`

**Alternatives:**

- `BM25Retriever`with custom queries (e.g. boosting) and filters
