...
**Cons**: Computationally more heavy to use, initial training of model (though this is less of an issue nowadays as we can grab and use one of the many pre-trained models available i.e. we don't usually need to train the model).
