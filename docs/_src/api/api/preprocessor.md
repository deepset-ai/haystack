...
```python
def __init__(clean_whitespace: bool = True, clean_header_footer: bool = False, clean_empty_lines: bool = True, split_by: str = "word", split_length: int = 1000, split_overlap: int = 0, split_respect_sentence_boundary: bool = True, language: str = "en")
```
...
<a id="utils.convert_files_to_dicts"></a>
...
<a id="utils.tika_convert_files_to_dicts"></a>

#### tika\_convert\_files\_to\_dicts

```python
def tika_convert_files_to_dicts(dir_path: str, clean_func: Optional[Callable] = None, split_paragraphs: bool = False, merge_short: bool = True, merge_lowercase: bool = True) -> List[dict]
```
...
<a id="utils.fetch_archive_from_http"></a>
...
<a id="cleaning.clean_wiki_text"></a>
