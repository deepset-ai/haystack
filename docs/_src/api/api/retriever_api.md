...
```python
def __init__(knowledge_graph: BaseKnowledgeGraph, model_name_or_path: str = None, model_version: Optional[str] = None, top_k: int = 1, use_auth_token: Optional[Union[str, bool]] = None)
```
