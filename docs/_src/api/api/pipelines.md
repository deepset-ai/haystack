...
<a id="base.BasePipeline.validate_config"></a>
...
- `pipeline_config`: the configuration to validate

**Raises**:

- `None`: `PipelineValidationError` in case of issues.

**Returns**:

None if validation is successful

<a id="base.BasePipeline.validate_yaml"></a>
