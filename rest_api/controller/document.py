...
def get_documents(filters: FilterRequest):
    ...
    `'{"filters": {}}'`
    """
    docs = [doc.to_dict() for doc in document_store.get_all_documents(filters=filters.filters)]  # type: ignore
    for doc in docs:
        doc["embedding"] = None
    return docs
...
def delete_documents(filters: FilterRequest):
    ...
    `'{"filters": {}}'`
    """
    document_store.delete_documents(filters=filters.filters)  # type: ignore
    return True
