...
```python
 | @abstractmethod
 | get_all_documents(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, return_embedding: Optional[bool] = None, batch_size: int = 10_000, headers: Optional[Dict[str, str]] = None) -> List[Document]
```
...
```python
 | @abstractmethod
 | get_all_documents_generator(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, return_embedding: Optional[bool] = None, batch_size: int = 10_000, headers: Optional[Dict[str, str]] = None) -> Generator[Document, None, None]
```
...
```python
 | get_all_labels_aggregated(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, open_domain: bool = True, drop_negative_labels: bool = False, drop_no_answers: bool = False, aggregate_by_meta: Optional[Union[str, list]] = None, headers: Optional[Dict[str, str]] = None) -> List[MultiLabel]
```
...
<a name="base.BaseDocumentStore.delete_index"></a>
...
```python
 | run(documents: List[Union[dict, Document]], index: Optional[str] = None, headers: Optional[Dict[str, str]] = None, id_hash_keys: Optional[List[str]] = None)
```
...
<a name="base.BaseDocumentStore.describe_documents"></a>
...
```python
 | @abstractmethod
 | query(query: Optional[str], filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, top_k: int = 10, custom_query: Optional[str] = None, index: Optional[str] = None, headers: Optional[Dict[str, str]] = None, all_terms_must_match: bool = False, scale_score: bool = True) -> List[Document]
```
...
<a name="base.KeywordDocumentStore.query_batch"></a>
#### KeywordDocumentStore.query\_batch

```python
 | @abstractmethod
 | query_batch(queries: List[str], filters: Optional[
 |             Union[
...
<a name="elasticsearch.prepare_hosts"></a>
#### prepare\_hosts

```python
prepare_hosts(host, port)
```
...
<a name="elasticsearch.BaseElasticsearchDocumentStore"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_document_by_id"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_documents_by_id"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_metadata_values_by_key"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.write_documents"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.write_labels"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.update_document_meta"></a>
#### BaseElasticsearchDocumentStore.update\_document\_meta

```python
 | update_document_meta(id: str, meta: Dict[str, str], index: str = None, headers: Optional[Dict[str, str]] = None)
```

Update the metadata dictionary of a document by specifying its string id

<a name="elasticsearch.BaseElasticsearchDocumentStore.get_document_count"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_label_count"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_embedding_count"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_all_documents"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_all_documents_generator"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.get_all_labels"></a>
#### BaseElasticsearchDocumentStore.get\_all\_labels

```python
 | get_all_labels(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, headers: Optional[Dict[str, str]] = None, batch_size: int = 10_000) -> List[Label]
```

Return all labels in the document store

<a name="elasticsearch.BaseElasticsearchDocumentStore.query"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.query_batch"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.query_by_embedding"></a>
#### BaseElasticsearchDocumentStore.query\_by\_embedding

```python
 | query_by_embedding(query_emb: np.ndarray, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, top_k: int = 10, index: Optional[str] = None, return_embedding: Optional[bool] = None, headers: Optional[Dict[str, str]] = None, scale_score: bool = True) -> List[Document]
```
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.update_embeddings"></a>
#### BaseElasticsearchDocumentStore.update\_embeddings

```python
 | update_embeddings(retriever, index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, update_existing_embeddings: bool = True, batch_size: int = 10_000, headers: Optional[Dict[str, str]] = None)
```
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.delete_all_documents"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.delete_documents"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.delete_labels"></a>
...
<a name="elasticsearch.BaseElasticsearchDocumentStore.delete_index"></a>
...
<a name="opensearch.OpenSearchDocumentStore"></a>
...
<a name="opensearch.OpenSearchDocumentStore.__init__"></a>
...
<a name="opensearch.OpenSearchDocumentStore.query_by_embedding"></a>
...
<a name="opensearch.OpenDistroElasticsearchDocumentStore"></a>
...
```python
 | __init__(index: str = "document", label_index: str = "label", embedding_field: Optional[str] = "embedding", embedding_dim: int = 768, return_embedding: bool = False, similarity: str = "dot_product", progress_bar: bool = True, duplicate_documents: str = "overwrite", use_gpu: bool = True, scoring_batch_size: int = 500000)
```
...
<a name="memory.InMemoryDocumentStore.get_scores_torch"></a>
#### InMemoryDocumentStore.get\_scores\_torch

```python
 | get_scores_torch(query_emb: np.ndarray, document_to_search: List[Document]) -> List[float]
```
...
<a name="memory.InMemoryDocumentStore.get_scores_numpy"></a>
#### InMemoryDocumentStore.get\_scores\_numpy

```python
 | get_scores_numpy(query_emb: np.ndarray, document_to_search: List[Document]) -> List[float]
```
...
<a name="memory.InMemoryDocumentStore.update_document_meta"></a>
#### InMemoryDocumentStore.update\_document\_meta

```python
 | update_document_meta(id: str, meta: Dict[str, Any], index: str = None)
```
...
<a name="memory.InMemoryDocumentStore.delete_index"></a>
...
<a name="sql.SQLDocumentStore.delete_index"></a>
...
```python
 | update_embeddings(retriever: "BaseRetriever", index: Optional[str] = None, update_existing_embeddings: bool = True, filters: Optional[Dict[str, Any]] = None, batch_size: int = 10_000)
```
...
```python
 | get_embedding_count(index: Optional[str] = None, filters: Optional[Dict[str, Any]] = None) -> int
```
...
<a name="faiss.FAISSDocumentStore.delete_index"></a>
...
<a name="milvus1.Milvus1DocumentStore"></a>
...
<a name="milvus1.Milvus1DocumentStore.__init__"></a>
...
<a name="milvus1.Milvus1DocumentStore.write_documents"></a>
...
<a name="milvus1.Milvus1DocumentStore.update_embeddings"></a>
#### Milvus1DocumentStore.update\_embeddings

```python
 | update_embeddings(retriever: "BaseRetriever", index: Optional[str] = None, batch_size: int = 10_000, update_existing_embeddings: bool = True, filters: Optional[Dict[str, Any]] = None)
```
...
<a name="milvus1.Milvus1DocumentStore.query_by_embedding"></a>
...
<a name="milvus1.Milvus1DocumentStore.delete_all_documents"></a>
...
<a name="milvus1.Milvus1DocumentStore.delete_documents"></a>
...
<a name="milvus1.Milvus1DocumentStore.delete_index"></a>
...
<a name="milvus1.Milvus1DocumentStore.get_all_documents_generator"></a>
...
<a name="milvus1.Milvus1DocumentStore.get_all_documents"></a>
...
<a name="milvus1.Milvus1DocumentStore.get_document_by_id"></a>
...
<a name="milvus1.Milvus1DocumentStore.get_documents_by_id"></a>
...
<a name="milvus1.Milvus1DocumentStore.get_all_vectors"></a>
...
<a name="milvus1.Milvus1DocumentStore.get_embedding_count"></a>
...
<a name="milvus2.Milvus2DocumentStore"></a>
...
<a name="milvus2.Milvus2DocumentStore.__init__"></a>
...
<a name="milvus2.Milvus2DocumentStore.write_documents"></a>
...
<a name="milvus2.Milvus2DocumentStore.update_embeddings"></a>
...
<a name="milvus2.Milvus2DocumentStore.query_by_embedding"></a>
...
<a name="milvus2.Milvus2DocumentStore.delete_documents"></a>
#### Milvus2DocumentStore.delete\_documents

```python
 | delete_documents(index: Optional[str] = None, ids: Optional[List[str]] = None, filters: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None, batch_size: int = 10_000)
```
...
<a name="milvus2.Milvus2DocumentStore.delete_index"></a>
...
<a name="milvus2.Milvus2DocumentStore.get_all_documents_generator"></a>
...
<a name="milvus2.Milvus2DocumentStore.get_all_documents"></a>
...
<a name="milvus2.Milvus2DocumentStore.get_document_by_id"></a>
...
<a name="milvus2.Milvus2DocumentStore.get_documents_by_id"></a>
...
<a name="milvus2.Milvus2DocumentStore.get_embedding_count"></a>
...
```python
 | update_document_meta(id: str, meta: Dict[str, Union[List, str, int, float, bool]], index: str = None)
```
...
```python
 | get_embedding_count(filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, index: Optional[str] = None) -> int
```
...
```python
 | query(query: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, top_k: int = 10, all_terms_must_match: bool = False, custom_query: Optional[str] = None, index: Optional[str] = None, headers: Optional[Dict[str, str]] = None, scale_score: bool = True) -> List[Document]
```
...
```python
 | update_embeddings(retriever, index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, update_existing_embeddings: bool = True, batch_size: int = 10_000)
```
...
<a name="weaviate.WeaviateDocumentStore.delete_index"></a>
...
<a name="weaviate.WeaviateDocumentStore.delete_labels"></a>
...
<a name="weaviate.WeaviateDocumentStore.get_all_labels"></a>
...
<a name="weaviate.WeaviateDocumentStore.get_label_count"></a>
...
<a name="weaviate.WeaviateDocumentStore.write_labels"></a>
...
<a name="deepsetcloud.disable_and_log"></a>
#### disable\_and\_log

```python
disable_and_log(func)
```
...
```python
 | __init__(api_key: str = None, workspace: str = "default", index: Optional[str] = None, duplicate_documents: str = "overwrite", api_endpoint: Optional[str] = None, similarity: str = "dot_product", return_embedding: bool = False, label_index: str = "default")
```
...
<a name="deepsetcloud.DeepsetCloudDocumentStore.update_document_meta"></a>
...
<a name="deepsetcloud.DeepsetCloudDocumentStore.get_evaluation_sets"></a>
#### DeepsetCloudDocumentStore.get\_evaluation\_sets

```python
 | get_evaluation_sets() -> List[dict]
```
...
<a name="deepsetcloud.DeepsetCloudDocumentStore.get_all_labels"></a>
#### DeepsetCloudDocumentStore.get\_all\_labels

```python
 | get_all_labels(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, headers: Optional[Dict[str, str]] = None) -> List[Label]
```
...
<a name="deepsetcloud.DeepsetCloudDocumentStore.get_label_count"></a>
...
<a name="pinecone.PineconeDocumentStore"></a>
...
<a name="pinecone.PineconeDocumentStore.write_documents"></a>
#### PineconeDocumentStore.write\_documents

```python
 | write_documents(documents: Union[List[dict], List[Document]], index: Optional[str] = None, batch_size: int = 32, duplicate_documents: Optional[str] = None, headers: Optional[Dict[str, str]] = None)
```
...
<a name="pinecone.PineconeDocumentStore.update_embeddings"></a>
#### PineconeDocumentStore.update\_embeddings

```python
 | update_embeddings(retriever: "BaseRetriever", index: Optional[str] = None, update_existing_embeddings: bool = True, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, batch_size: int = 32)
```
...
<a name="pinecone.PineconeDocumentStore.get_all_documents_generator"></a>
#### PineconeDocumentStore.get\_all\_documents\_generator

```python
 | get_all_documents_generator(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None, return_embedding: Optional[bool] = None, batch_size: int = 32, headers: Optional[Dict[str, str]] = None) -> Generator[Document, None, None]
```
...
<a name="pinecone.PineconeDocumentStore.get_embedding_count"></a>
#### PineconeDocumentStore.get\_embedding\_count

```python
 | get_embedding_count(index: Optional[str] = None, filters: Optional[Dict[str, Union[Dict, List, str, int, float, bool]]] = None) -> int
```

Return the count of embeddings in the document store.

<a name="pinecone.PineconeDocumentStore.update_document_meta"></a>
...
<a name="pinecone.PineconeDocumentStore.delete_documents"></a>
...
<a name="pinecone.PineconeDocumentStore.delete_index"></a>
...
<a name="pinecone.PineconeDocumentStore.query_by_embedding"></a>
...
<a name="pinecone.PineconeDocumentStore.load"></a>
...
<a name="utils.convert_date_to_rfc3339"></a>
#### convert\_date\_to\_rfc3339

```python
convert_date_to_rfc3339(date: str) -> str
```
