...
def tutorial2_finetune_a_model_on_your_data():
    ...
    reader.train(data_dir=data_dir, train_filename="dev-v2.0.json", use_gpu=False, n_epochs=1, save_dir="my_model")
    reader.eval_on_file(data_dir=data_dir, test_filename="dev-v2.0.json")

    # Saving the model happens automatically at the end of training into the `save_dir` you specified
    # However, you could also save a reader manually again via:
    reader.save_to_remote(directory="my_model")
