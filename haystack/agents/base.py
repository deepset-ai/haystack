    ...
    def run(
        ...
        for _ in range(max_iterations):
            ...
            if tool_name == "Final Answer":
                return {
                    "query": query,
                    "answers": [Answer(answer=tool_input, type="generative")],
                    "transcript": transcript + pred,
                }
        ...
        return {"query": query, "answers": [Answer(answer="", type="generative")], "transcript": transcript}
