...
class TextToSpeech:
    ...
    def text_to_audio_file(
        ...
        :param bitrate: Used only for compressed formats. The desired bitrate of your compressed audio. Default to '320k'
        :param normalized: Used only for compressed formats. Whether to normalize the audio before compression (range 2^15) or leave it untouched
    ...
    def compress_audio(
        ...
        :param normalized: whether to normalize the audio before compression (range 2^15) or leave it untouched
        """
