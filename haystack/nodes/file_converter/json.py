...
class JsonConverter(BaseConverter):
    """Converter Node to read json files with documents."""
    ...
    def convert(
        ...
        - or a jsonl file with every line containing either a Document dict or a list of dicts

        :param file_path: Path to the json file to be converted.
