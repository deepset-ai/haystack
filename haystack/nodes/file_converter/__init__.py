...
PDFToTextConverter = safe_import("haystack.nodes.file_converter.pdf", "PDFToTextConverter", "ocr")  # Has optional dependencies
PDFToTextOCRConverter = safe_import("haystack.nodes.file_converter.pdf", "PDFToTextOCRConverter", "ocr")  # Has optional dependencies
