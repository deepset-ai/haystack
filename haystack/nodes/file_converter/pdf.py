...
class PDFToTextConverter(BaseConverter):
    ...
    def convert(
        ...
        pages = self._read_pdf(file_path, layout=keep_physical_layout, start_page=start_page, end_page=end_page)
    ...
    def _read_pdf(
        self, file_path: Path, layout: bool, start_page: Optional[int] = None, end_page: Optional[int] = None
    ) -> List[str]:
        """
        ...
        for i in range(start_page, end_page):
            page = doc[i]
            document += page.get_text("text", sort=True if layout else False) + "\f"
