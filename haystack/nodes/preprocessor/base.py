...
class BasePreProcessor(BaseComponent):
    ...
    def process(
        ...
        split_by: Literal["word","token", "sentence", "passage", None] = "word",
    ...
    def split(
        self,
        document: Union[dict, Document],
        split_by: Literal["word", "token","sentence", "passage", None],
        split_length: int,
        split_overlap: int,
    ...
    def run(  # type: ignore
        ...
        split_by: Literal["word", "token","sentence", "passage", None] = None,
