...
class BaseDocumentStore(BaseComponent):
    ...
    def run(self, documents: List[Union[dict, Document]], index: Optional[str] = None,
            headers: Optional[Dict[str, str]] = None, id_hash_keys: Optional[List[str]] = None):  # type: ignore
        """
        ...
        doc_objects = [Document.from_dict(d, field_map=field_map, id_hash_keys=id_hash_keys)
