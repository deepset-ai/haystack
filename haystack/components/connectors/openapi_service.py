...
class OpenAPIServiceConnector:
    """
    The `OpenAPIServiceConnector` component links the Haystack framework to OpenAPI services, enabling it to call
    operations as defined in the service's OpenAPI specification.
