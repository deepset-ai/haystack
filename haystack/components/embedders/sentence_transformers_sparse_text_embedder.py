...
class SentenceTransformersSparseTextEmbedder:
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        """
        warnings.warn(
            "`SentenceTransformersSparseTextEmbedder` will be removed from Haystack in version 3.0, as it is moving "
            "to the `sentence-transformers-haystack` package. To continue using it, install that package with "
