...
class Document:
    ...
    def __init__(
        ...
        :param id_hash_keys: Generate the document id from a custom list of strings that refere to the documents attributes.
                             If you want to ensure you don't have duplicate documents in your DocumentStore but texts are
                             not unique, you can modify the metadata and pass e.g. "meta" to this field (e.g. ["content", "meta"]).
                             In this case the id will be generated by using the content and the defined metadata.
                             If you specify a custom ID on the `id` parameter, the `id_hash_keys` parameter will be
                             ignored and the custom ID will be used.
        """
