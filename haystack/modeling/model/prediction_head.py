...
class QuestionAnsweringHead(PredictionHead):
    ...
    @classmethod
    def load(cls, pretrained_model_name_or_path: Union[str, Path], revision: Optional[str] = None, transformers_args: Optional[Dict] = None):  # type: ignore
        """
        ...
        if (
            ...
            full_qa_model = AutoModelForQuestionAnswering.from_pretrained(
                pretrained_model_name_or_path, revision=revision, **transformers_args
            )
            # init empty head
