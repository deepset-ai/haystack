...
try:
    ...
    try:
        ...
        logger.info("apex.parallel not found, won't use it."
                    "See https://nvidia.github.io/apex/parallel.html")
    ...
    AMP_AVAILABLE = False
    APEX_PARALLEL_AVAILABLE = False
    logger.info("apex not found, won't use it. "
                "See https://nvidia.github.io/apex/")
