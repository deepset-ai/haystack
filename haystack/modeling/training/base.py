...
class Trainer:
    ...
    def train(self):
        ...
        elif not isinstance(self.model.language_model, DebertaV2): # DebertaV2 has mismatched vocab size on purpose (see https://github.com/huggingface/transformers/issues/12428)
