            ...
            while True:
                ...
                if break_point and (component_break_point_triggered or agent_break_point_triggered):
                    ...
                    if component_break_point_triggered:
                        _trigger_break_point(
                            pipeline_snapshot=new_pipeline_snapshot, snapshot_callback=snapshot_callback
                        )
                ...
                try:
                    ...
                    full_file_path = _save_pipeline_snapshot(
                        pipeline_snapshot=pipeline_snapshot, raise_on_failure=False, snapshot_callback=snapshot_callback
                    )
