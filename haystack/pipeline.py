...
class Pipeline(BasePipeline):
    ...
    def load_from_yaml(cls, path: Path, pipeline_name: Optional[str] = None, overwrite_with_env_variables: bool = True):
        ...
        pipeline = cls._load_from_config(pipeline_config, definitions)
        return pipeline

    @classmethod
    def _load_from_config(cls, pipeline_config, definitions):
        pipeline = cls()
...
class _RayPipelineWrapperNode:
    def __init__(self, pipeline_config, definitions):
        self.pipeline = Pipeline._load_from_config(pipeline_config, definitions)
