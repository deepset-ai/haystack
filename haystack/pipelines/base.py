...
class BasePipeline:
    ...
    @classmethod
    def _remove_nested_keys_from_json_schema(cls, schema: Any, key_to_remove: str) -> Dict:
        """
    ...
    @classmethod
    def validate_config(cls, pipeline_config: Dict, version: str = __version__) -> None:
        """
    ...
    @classmethod
    def validate_yaml(cls, path: Path, version: str = __version__):
        """
        Validates the given configuration using the autogenerated JSON schema for the specified version
        (defaults to the version of the currently installed Haystack).
