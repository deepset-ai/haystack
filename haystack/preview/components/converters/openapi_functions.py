...
class OpenAPIServiceToFunctions:
    ...
    def run(self, service_spec_url: str) -> Dict[str, Any]:
        ...
        mechanism. It downloads the OpenAPI specification, processes it, and extracts function definitions. The
        extracted functions format is OpenAI function calling JSON.
