...
class TextFileToDocument:
    ...
    def __init__(
        ...
        :param id_hash_keys: Generate the Document ID from a custom list of strings that refer to the Document's
            ...
            unique, you can pass to this field the name of the metadata to use when building the document ID (like
            `["text", "category"]`). In this case the ID will be generated by using the text and the content of the
