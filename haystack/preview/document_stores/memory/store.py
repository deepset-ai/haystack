...
class MemoryDocumentStore:
    ...
    def __init__(
        ...
        # For BM25 retrieval
        self.bm25 = BM25Representation(**bm25_parameters) if use_bm25 else None
    ...
    def write_documents(self, documents: List[Document], duplicates: DuplicatePolicy = "fail") -> None:
        ...
        :return: None
        """
        if not isinstance(documents, Iterable) and not all(isinstance(doc, Document) for doc in documents):
