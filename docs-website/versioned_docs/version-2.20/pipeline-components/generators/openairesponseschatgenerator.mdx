...
client = OpenAIResponsesChatGenerator(generation_kwargs={"reasoning": {"effort": "medium", "summary": "auto"}})
...
client = OpenAIResponsesChatGenerator(model="gpt-4o", generation_kwargs={"text_format": BookInfo})
...
client = OpenAIResponsesChatGenerator(model="gpt-4o", generation_kwargs={"text": json_schema})
...
llm = OpenAIResponsesChatGenerator(generation_kwargs={"reasoning": {"effort": "low", "summary": "auto"}})
