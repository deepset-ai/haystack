...
title: "Pipelines"
id: "pipelines"
excerpt: "To build modern search pipelines with LLMs, you need two things: powerful components and an easy way to put them together. The Haystack pipeline is built for this purpose and enables you to design and scale your interactions with LLMs."
hidden: false
createdAt: "Tue Aug 16 2022 10:08:21 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon May 12 2025 09:57:46 GMT+0000 (Coordinated Universal Time)"
---
...
![Branching Pipeline Illustration](../assets/pipeline-illustration-1.png)
...
![Looping Pipeline Illustration](../assets/pipeline-illustration-2.png)
...
Find out more in our [AsyncPipeline](doc:asyncpipeline) documentation.

# SuperComponents

To simplify your code, we have introduced [SuperComponents](doc:supercomponents) that allow you to wrap complete pipelines and reuse them as a single component. Check out their documentation page for the details and examples.
