...
msg = ChatMessage.from_user("long message...", meta={"cachePoint": {"type": "default", "ttl": "5m"}})

generator = AmazonBedrockChatGenerator(model="anthropic.claude-sonnet-4-5-20250929-v1:0")
