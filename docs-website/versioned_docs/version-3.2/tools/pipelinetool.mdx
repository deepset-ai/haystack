...
The examples on this page use Sentence Transformers components (a ranker and embedders) from the `sentence-transformers-haystack` package. Install it to run the examples:
