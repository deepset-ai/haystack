...
description: "Use this component with IBM watsonx models like `granite-4-h-small` for chat generation."
---

# WatsonxChatGenerator

Use this component with IBM watsonx models like `granite-4-h-small` for chat generation.
