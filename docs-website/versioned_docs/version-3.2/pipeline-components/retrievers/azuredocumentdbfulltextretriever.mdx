...
Full-text search in Azure DocumentDB is in gated preview and must be enabled on your cluster. For how to request access, see [full-text search in Azure DocumentDB](https://learn.microsoft.com/azure/documentdb/full-text-search-overview).
