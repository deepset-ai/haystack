...
[`OpenSearchBM25Retriever`](/docs/opensearchbm25retriever): A keyword-based Retriever that fetches documents matching a query from the Document Store.

[`OpenSearchEmbeddingRetriever`](/docs/opensearchembeddingretriever): Compares the query and document embeddings and fetches the documents most relevant to the query.
