...
To show the internal structure of [SuperComponents](doc:supercomponents) in your digram instead of a black box component, set the `super_component_expansion` parameter to `True`:
