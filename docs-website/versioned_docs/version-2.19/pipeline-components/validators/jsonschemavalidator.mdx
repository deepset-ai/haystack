...
| **Mandatory run variables** | “messages”: A list of [`ChatMessage`](/docs/data-classes#chatmessage)  instances to be validated – the last message in this list is the one that is validated |
