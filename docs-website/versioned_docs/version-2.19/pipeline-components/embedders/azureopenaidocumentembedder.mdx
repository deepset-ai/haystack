...
| **Mandatory init variables** | "api_key": The Azure OpenAI API key. Can be set with `AZURE_OPENAI_API_KEY` env var.   "azure_endpoint": The endpoint of the model deployed on Azure. |
...
This component should be used to embed a list of documents. To embed a string, you should use the [`AzureOpenAITextEmbedder`](/docs/azureopenaitextembedder).
