...
For embedding lists of documents, use the [`SentenceTransformersSparseDocumentEmbedder`](/docs/sentencetransformerssparsedocumentembedder), which enriches the document with the computed sparse embedding.
