...
|                                        |                                                                                                                                                                                                                   |
| :------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Most common position in a pipeline** | 1. Before a [ChatPromptBuilder](doc:chatpromptbuilder) in a RAG pipeline 2. The last component in the semantic search pipeline 3. Before an [ExtractiveReader](doc:extractivereader) in an extractive QA pipeline |
