...
- **ChatGenerators** support the [ChatMessage data class](/docs/data-classes#chatmessage) out of the box. They expect a list of Chat Messages and return a Chat Message in “replies”.
