...
|  |  |
| --- | --- |
| **Most common position in a pipeline** | Right at the beginning of a pipeline and before a [ChatPromptBuilder](doc:chatpromptbuilder) that expects the content of GitHub files as input |
