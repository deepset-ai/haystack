...
| **Mandatory init variables**           | `type_`: The type of data expected from preceding components                                                                                             |
...
The examples on this page use language classification components from the `langdetect-haystack` package. Install it to run the examples:
