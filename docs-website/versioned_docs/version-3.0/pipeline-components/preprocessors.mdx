...
| [EmbeddingBasedDocumentSplitter](preprocessors/embeddingbaseddocumentsplitter.mdx) | Splits documents based on embedding similarity using cosine distances between sequential sentence groups. |
