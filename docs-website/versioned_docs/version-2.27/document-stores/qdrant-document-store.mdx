...
Qdrant is a powerful, high-performance, massive-scale vector database. The `QdrantDocumentStore` can be used with any Qdrant instance: in-memory, locally persisted, hosted, or on Qdrant Cloud.
