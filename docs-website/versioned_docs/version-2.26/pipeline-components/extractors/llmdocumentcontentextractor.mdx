...
2. Using a predefined prompt to instruct the LLM on how to extract content and metadata,
3. Processing the image through a vision-capable ChatGenerator to extract structured output.
