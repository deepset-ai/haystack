...
- `remove_empty_rows`: Whether to remove entirely empty rows, including blank lines. Preserved blank lines are written as empty CSV records with the remaining number of columns.
