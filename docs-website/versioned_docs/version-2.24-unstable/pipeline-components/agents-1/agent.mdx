...
## Run
result = coordinator_agent.run(messages=[ChatMessage.from_user("Tell me about Haystack")])
...
agent_output = extraction_agent.run({"fetcher": {"urls": ["https://haystack.deepset.ai/release-notes/v2.20.0"]}})
