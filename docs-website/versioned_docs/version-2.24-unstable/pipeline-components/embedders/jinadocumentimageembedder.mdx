...
indexing_pipeline.add_component("embedder", JinaDocumentImageEmbedder(model="jina-clip-v2", image_size=(200, 200)))
...
retrieval_pipeline.add_component("retriever", InMemoryEmbeddingRetriever(document_store=document_store, top_k=2))
