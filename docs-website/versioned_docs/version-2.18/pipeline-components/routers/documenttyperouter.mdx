...
| **Mandatory run variables** | "documents": A list of [Documents](/docs/data-classes#document) to categorize |
| **Output variables** | "unclassified": A list of uncategorized [Documents](/docs/data-classes#document)  <br /> <br />"mime_types": For example "text/plain", "application/pdf", "image/jpeg": List of categorized [Documents](/docs/data-classes#document) |
