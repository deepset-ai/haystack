...
| **Mandatory run variables** | “query_sparse_embedding”: A [`SparseEmbedding`](/docs/data-classes#sparseembedding)  object containing a vectorial representation of the query |
