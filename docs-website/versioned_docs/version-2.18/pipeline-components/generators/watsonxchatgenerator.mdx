...
| **Output variables** | "replies": A list of [`ChatMessage`](/docs/data-classes#chatmessage)  objects |
...
- The `api_key` and `project_id` init parameters using [Secret API](/docs/secret-management)
