...
|  |  |
| --- | --- |
| **Most common position in a pipeline** | Use in pipelines (such as a RAG pipeline) after a [Generator](../generators.mdx)  component to create [`GeneratedAnswer`](/docs/data-classes#generatedanswer)   objects from its replies. |
| **Mandatory run variables** | “query”: A query string  <br /> <br />”replies”: A list of strings, or a list of [`ChatMessage`](/docs/data-classes#chatmessage)   objects that are replies from a Generator |
