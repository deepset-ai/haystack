...
|  |  |
| --- | --- |
| **Most common position in a pipeline** | At the end of a pipeline, after [GitHubRepoForker](doc:githubrepoforker), [GitHubFileEditor](githubfileeditor.mdx) and other components that prepare changes for submission |
