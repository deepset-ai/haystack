...
|  |  |
| --- | --- |
| **Most common position in a pipeline** | Right at the beginning of a pipeline and before an [Agent](doc:agent) component that expects the name of a GitHub branch as input |
