...
There are two ways of performing model-based evaluation in Haystack, both of which leverage [Pipelines](/docs/pipelines) and [Evaluator](/docs/evaluators) components.
...
#### [ContextRelevanceEvaluator](/docs/contextrelevanceevaluator)
...
#### [FaithfulnessEvaluator](/docs/faithfulnessevaluator)
...
#### [SASEvaluator](/docs/sasevaluator) (Semantic Answer Similarity)
...
- [RagasEvaluator](/docs/ragasevaluator)
- [DeepEvalEvaluator](/docs/deepevalevaluator)
