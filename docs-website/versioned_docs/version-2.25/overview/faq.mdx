...
If you need documentation for Haystack 2.17 or earlier, you can download it as a ZIP file. The ZIP file includes
documentation for all minor releases from version 2.0 to 2.17.

To download the documentation for a specific release, replace the version number in the following
URL: https://core-engineering.s3.eu-central-1.amazonaws.com/public/docs/v2.17.zip.
