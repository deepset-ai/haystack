...
To use the `AnthropicVertexChatGenerator`, ensure you have a GCP project with Vertex AI enabled. You need to pass your GCP `project_id` and `region` as init parameters.
