...
- **ChatGenerators** support the [ChatMessage data class](../../../concepts/data-classes.mdx#chatmessage) out of the box. They expect a list of Chat Messages and return a Chat Message in “replies”.
...
Check out the parameter details in our [API Reference for StreamingChunk](/reference/data-classess-api#streamingchunk).
:::
