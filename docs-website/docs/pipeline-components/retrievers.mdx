...
| [MultiFilterRetriever](retrievers/multifilterretriever.mdx)                       | A special Retriever to be used with any Document Store to retrieve Documents matching multiple filters in parallel.              |
