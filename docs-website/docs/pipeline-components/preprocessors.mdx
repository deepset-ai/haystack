...
| [Presidio](preprocessors/presidio.mdx) | Detects and anonymizes PII in Documents and text strings using Microsoft Presidio. Includes `PresidioDocumentCleaner`, `PresidioTextCleaner`, and `PresidioEntityExtractor`. |
