...
| [SearchApiWebSearch](websearch/searchapiwebsearch.mdx) | Search engine using Search API. **_Provided by the `searchapi-haystack` integration package._**    |
| [SerperDevWebSearch](websearch/serperdevwebsearch.mdx) | Search engine using SerperDev API. **_Provided by the `serperdev-haystack` integration package._** |
