...
Amazon Titan and Cohere multimodal embedding models are supported, for example `amazon.titan-embed-image-v1`, `cohere.embed-english-v3`, `cohere.embed-multilingual-v3`, and `cohere.embed-v4:0`.
