...
The component supports Cohere models such as
`"embed-v4.0"`, `"embed-english-v3.0"`, `"embed-english-light-v3.0"`, `"embed-multilingual-v3.0"`, and
`"embed-multilingual-light-v3.0"`. The default model is `embed-v4.0`. The list of all supported models can be found in Cohere’s [model documentation](https://docs.cohere.com/docs/models#embed).
