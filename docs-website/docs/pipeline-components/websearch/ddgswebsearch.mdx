...
id: ddgswebsearch
slug: "/ddgswebsearch"
description: "Keyless multi-engine web search using ddgs (Dux Distributed Global Search)."
---

# DDGSWebSearch

Search the web with ddgs (Dux Distributed Global Search), a keyless metasearch library that aggregates results from multiple search engines.
