...
To use [Tavily](https://tavily.com/) as an alternative web search provider, see the `TavilyWebSearch` component. Tavily offers an AI-optimised search API that can serve as a drop-in replacement in most pipelines.
:::
