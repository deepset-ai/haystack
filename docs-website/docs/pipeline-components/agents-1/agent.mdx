...
See [Multi-Agent Systems](../../concepts/multi-agent-systems.mdx) for a full guide, including the recommended `@tool` decorator approach and the `ComponentTool` alternative for YAML-based pipelines.
