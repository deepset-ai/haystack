...
| [`ToolResultOffloadCompactor`](tool-result-offload-compactor.mdx) | Stores eligible older tool results and leaves retrievable references while keeping recent results intact. |
