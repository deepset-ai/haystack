...
| **Mandatory run variables**            | "sources": A list of HTML file paths or [`ByteStream`](../../concepts/data-classes.mdx#bytestresm)  objects  |
