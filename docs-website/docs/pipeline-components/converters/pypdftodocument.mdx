...
| **Mandatory run variables**            | "sources": PDF file paths or [`ByteStream`](../../concepts/data-classes.mdx#bytestresm)  objects             |
