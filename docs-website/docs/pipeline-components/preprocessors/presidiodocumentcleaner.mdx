...
If you want to annotate PII without modifying the text, see [`PresidioEntityExtractor`](/presidioentityextractor). For sanitizing plain strings such as user queries, see [`PresidioTextCleaner`](/presidiotextcleaner).
