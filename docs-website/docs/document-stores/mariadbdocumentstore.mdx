...
- [`MariaDBBM25Retriever`](../pipeline-components/retrievers/mariadbbm25retriever.mdx): A keyword-based Retriever that fetches documents matching a query using MariaDB's full-text search.
