...
Documentation for Haystack versions older than 6 months is not available on the main documentation website. You can access it on GitHub in the corresponding version branch. For example, the docs for Haystack 2.19 can be found at [https://github.com/deepset-ai/haystack/tree/v2.19.x/docs-website/docs](https://github.com/deepset-ai/haystack/tree/v2.19.x/docs-website/docs).
