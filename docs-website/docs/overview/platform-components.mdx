...
The Haystack Enterprise Platform currently supports **248 components** and **77 integrations**. The following table lists them grouped by integration partner.
...
| BedrockKnowledgeBaseRetriever | Retriever | ✅ Available |
