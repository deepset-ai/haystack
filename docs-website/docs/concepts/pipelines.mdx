...
Compatible outputs can be implicitly combined when connected to a single input, and certain types can be flexibly connected without additional adapters.
...
See [Smart Pipeline Connections](pipelines/smart-connections.mdx) for details and examples.
