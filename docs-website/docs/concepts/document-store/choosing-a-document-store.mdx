...
| Azure DocumentDB | Document / NoSQL Database | Managed MongoDB-compatible document database (Microsoft Azure) built on the open source DocumentDB engine, with DiskANN, HNSW, and IVF vector search | No | Yes | Embedding, Full-text |
