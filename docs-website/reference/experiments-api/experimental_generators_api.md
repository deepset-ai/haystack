...
- **hallucination_score_config** (<code>HallucinationScoreConfig | None</code>) – If provided, the generator will evaluate the hallucination risk of its responses using
