...
Browse to the Azure DevOps Demo Generator site by click the link, or copy https://azuredevopsdemogenerator.azurewebsites.net/ into your browser's URL field.

Click Sign In and provide the Microsoft or Azure AD account credentials associated with an organization in Azure DevOps Services. If you don't have an organization, click on Get Started for Free to create one and then log in with your credentials.


After you sign in, select Accept to grant the Demo Generator permissions to access your Azure DevOps account.

Select the organization you will use to host the project created by the Azure DevOps Demo Generator. (You may have multiple accounts of which you are a member, and which are associated with your login, so choose carefully.) Provide a name for your project (such as "MyProjectDemo" ) that you and other contributors can use to identify it as a demo project.
...
Your project may take a couple of minutes for the Demo Generator to provision. When it completes, you will be provided with a link to the demo project.
Select the Navigate to project button to the new demo Azure DevOps Services project and confirm it was successfully provisioned.
