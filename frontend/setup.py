...
setup(
    ...
    version="1.0.0",
    author="Tanmay Laud",
    author_email="tanmaylaud@gmail.com",
    description="Frontend Demo for Neural Question Answering & Semantic Search at Scale. Use modern transformer based models like BERT to find answers in large document collections",
    ...
    download_url="https://github.com/deepset-ai/haystack/archive/0.5.0.tar.gz",
