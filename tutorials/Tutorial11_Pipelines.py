...
def tutorial11_pipelines():
    ...
    p_extractive_premade = ExtractiveQAPipeline(reader=reader, retriever=retriever)
    ...
    p_ensemble = Pipeline()
    p_ensemble.add_node(component=retriever, name="ESRetriever", inputs=["Query"])
    ...
    p_classifier.add_node(component=retriever, name="ESRetriever", inputs=["QueryClassifier.output_1"])
