...
def tutorial10_knowledge_graph():
    ...
    s3_url = "https://s3.eu-central-1.amazonaws.com/deepset.ai-farm-qa/datasets/documents/tutorial10_knowledge_graph.zip"
    fetch_archive_from_http(url=s3_url, output_dir=doc_dir)

    # Further we need to fetch a pre-trained model that translates natural language questions to SPARQL queries
