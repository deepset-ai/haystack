...
def test_factory_behavior(mock_sentence_transformer):
    ...
    same_embedding_backend = SentenceTransformersEmbeddingBackendFactory.get_embedding_backend("my_model", "cpu")
    another_embedding_backend = SentenceTransformersEmbeddingBackendFactory.get_embedding_backend(
