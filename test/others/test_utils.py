...
def test_deprecation_previous_major_and_minor():
    with mock.patch.object(conftest, "haystack_version", "2.2.2-rc0"), pytest.warns(match="This feature is marked for removal in v1.1"):
...
def test_deprecation_previous_major_same_minor():
    with mock.patch.object(conftest, "haystack_version", "2.2.2-rc0"), pytest.warns(match="This feature is marked for removal in v1.2"):
...
def test_deprecation_previous_major_later_minor():
    with mock.patch.object(conftest, "haystack_version", "2.2.2-rc0"), pytest.warns(match="This feature is marked for removal in v1.3"):
...
def test_deprecation_same_major_previous_minor():
    with mock.patch.object(conftest, "haystack_version", "2.2.2-rc0"), pytest.warns(match="This feature is marked for removal in v2.1"):
...
def test_deprecation_same_major_same_minor():
    with mock.patch.object(conftest, "haystack_version", "2.2.2-rc0"), pytest.warns(match="This feature is marked for removal in v2.2"):
