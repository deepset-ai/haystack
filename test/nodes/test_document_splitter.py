...
split_by_word_args = [
    ...
    ("Another alphabeth", "Это еще один простой тест. ", ["Это ", "еще ", "один ", "простой ", "тест. "], 1, 0),
    # Chinese doesn't really work as there's no whitespace.
    ("Another character set", "今天不是晴天，因为下雨了。昨天天气比较好。", ["今天不是晴天，因为下雨了。昨天天气比较好。"], 1, 0),
    (
