...
remove_regex_matches_args = [
    ...
    (
        ...
        [
            {"content": "# Test1header", "start_idx": 3},
            {"content": "# Test2header", "start_idx": 19},
            {"content": "# Test3header", "start_idx": 33},
            {"content": "# Test4header", "start_idx": 55},
        ],
        [
            {"content": "# Test1header", "start_idx": 0},
            {"content": "# Test2header", "start_idx": 16},
            {"content": "# Test3header", "start_idx": 30},
            {"content": "# Test4header", "start_idx": 49},
        ],
    ),
    (
...
and this is another long piece of text from the second page of the document.\f""",
        [
            ...
            {"content": "Headline", "start_idx": 118},
...
and this is another long piece of text from the second page of the document.\f""",
        [
            ...
            {"content": "Footer Headline", "start_idx": 241},
...
remove_whitespace_args = [
    ...
    (
        ...
        "\n\n a \n#Title \f\f\f d  \n #Title2 \f\n\n\n\n",
        "\n\na\n#Title\f\f\fd\n#Title2\f\n\n\n\n",
        [{"content": "#Title2", "start_idx": 22}, {"content": "#Title", "start_idx": 6}],
