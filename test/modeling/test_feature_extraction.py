...
class TestFeatureExtraction:
    ...
    def mock_autotokenizer(request, monkeypatch):
        ...
        monkeypatch.setattr(haystack.modeling.model.tokenization, "AutoTokenizer", MockedTokenizer)
    ...
    def test_tokenize_custom_vocab_bert():
        ...
        assert (
            tokenized
            == f"Some Text with neverseentokens plus ! 215 ? # . and a combined - token _ with / ch ##ars".split()
        )
