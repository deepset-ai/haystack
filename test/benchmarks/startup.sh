...
docker run --name weaviate -d -p 8080:8080 -e "AUTHENTICATION_ANONYMOUS_ACCESS_ENABLED=true" -e "PERSISTENCE_DATA_PATH=/var/lib/weaviate" semitechnologies/weaviate:1.20.3
