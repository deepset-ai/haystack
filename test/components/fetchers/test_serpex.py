...
from haystack.components.fetchers.serpex import SerpexWebSearch
...
class TestSerpexWebSearch:
    def test_init_default_params(self):
        ...
        fetcher = SerpexWebSearch(api_key="test-api-key")
    ...
    def test_init_custom_params(self):
        ...
        fetcher = SerpexWebSearch(
            api_key="test-key", engine="bing", num_results=5, timeout=20, retry_attempts=3
        )
    ...
    def test_to_dict(self):
        ...
        fetcher = SerpexWebSearch(api_key="test-api-key", engine="duckduckgo", num_results=15)
    ...
    def test_from_dict(self):
        ...
        data = {
            "type": "haystack.components.fetchers.serpex.SerpexWebSearch",
            "init_parameters": {
                "api_key": "test-key",
                "engine": "brave",
                "num_results": 20,
    ...
    def test_run_with_mock_response(self, mock_serpex_response):
        ...
        with patch("haystack.components.fetchers.serpex.httpx.Client.get") as mock_get:
    ...
    def test_run_with_engine_override(self, mock_serpex_response):
        ...
        with patch("haystack.components.fetchers.serpex.httpx.Client.get") as mock_get:
            ...
            fetcher = SerpexWebSearch(api_key="test-api-key", engine="google")
    ...
    def test_run_with_num_results_override(self, mock_serpex_response):
        ...
        with patch("haystack.components.fetchers.serpex.httpx.Client.get") as mock_get:
            ...
            fetcher = SerpexWebSearch(api_key="test-api-key", num_results=10)
    ...
    def test_run_with_http_error(self):
        ...
        with patch("haystack.components.fetchers.serpex.httpx.Client.get") as mock_get:
            ...
            fetcher = SerpexWebSearch(api_key="invalid-key")
    ...
    def test_run_verifies_api_key_in_headers(self, mock_serpex_response):
        ...
        with patch("haystack.components.fetchers.serpex.httpx.Client.get") as mock_get:
            ...
            fetcher = SerpexWebSearch(api_key="secret-key-123")
            fetcher.run(query="test query")
