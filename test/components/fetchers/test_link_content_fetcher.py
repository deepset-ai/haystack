...
class TestLinkContentFetcher:
    ...
    def test_init_does_not_mutate_client_kwargs(self):
        """The caller's dictionary must not pick up the component's defaults."""
        ...
        assert fetcher.client_kwargs["timeout"] == 10
        assert fetcher.client_kwargs["follow_redirects"] is True
