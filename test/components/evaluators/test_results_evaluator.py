...
def test_score_report():
    ...
    assert (
        result
        == '{"score":{"reciprocal_rank":0.476932,"single_hit":0.75,"multi_hit":0.46428375,"context_relevance":0.58177975,"faithfulness":0.40585375,"semantic_answer_similarity":0.53757075}}'
    )
