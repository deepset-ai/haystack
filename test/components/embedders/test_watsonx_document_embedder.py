...
class TestWatsonXDocumentEmbedder:
    ...
    def mock_watsonx(self, monkeypatch):
        ...
        with patch('haystack.components.embedders.watsonx_document_embedder.Embeddings') as mock_embeddings, \
    ...
    def test_run_wrong_input_format(self, mock_watsonx):
        ...
        with pytest.raises(
            TypeError, 
            match="WatsonXDocumentEmbedder expects a list of Documents as input."
        ):
    ...
    def test_run_empty_documents(self, mock_watsonx):
        ...
        assert result == {"documents": [], "meta": {"model": "ibm/slate-30m-english-rtrvr", "truncate_input_tokens": None, "batch_size": 1000}}
