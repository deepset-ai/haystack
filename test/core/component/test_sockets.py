...
class TestSockets:
    def test_init(self):
        ...
        sockets = {
            "input_1": InputSocket("input_1", int, component=comp),
            "input_2": InputSocket("input_2", int, component=comp),
        }
        ...
        assert io.__dict__["input_1"] == comp.inputs._sockets_dict["input_1"]
        assert "input_2" in io.__dict__
        assert io.__dict__["input_2"] == comp.inputs._sockets_dict["input_2"]
    ...
    def test_getattribute(self):
        ...
        assert io.input_1 == comp.inputs._sockets_dict["input_1"]
        assert io.input_2 == comp.inputs._sockets_dict["input_2"]
