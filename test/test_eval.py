...
def test_generativeqa_calculate_metrics(
    ...
    metrics = eval_result.calculate_metrics(document_relevance_criterion="id")
...
def test_extractive_qa_eval(reader, retriever_with_docs, tmp_path):
    ...
    metrics = saved_eval_result.calculate_metrics(document_relevance_criterion="id")
...
@pytest.mark.parametrize("retriever_with_docs", ["tfidf"], indirect=True)
@pytest.mark.parametrize("document_store_with_docs", ["memory"], indirect=True)
def test_extractive_qa_eval_document_relevance_criterion(reader, retriever_with_docs):
    pipeline = ExtractiveQAPipeline(reader=reader, retriever=retriever_with_docs)
    eval_result: EvaluationResult = pipeline.eval(labels=EVAL_LABELS, params={"Retriever": {"top_k": 5}})

    metrics = eval_result.calculate_metrics(document_relevance_criterion="id_or_answer")
...
def test_extractive_qa_eval_simulated_top_k_reader(reader, retriever_with_docs):
    ...
    metrics_top_1 = eval_result.calculate_metrics(simulated_top_k_reader=1, document_relevance_criterion="id")
    ...
    metrics_top_2 = eval_result.calculate_metrics(simulated_top_k_reader=2, document_relevance_criterion="id")
    ...
    metrics_top_3 = eval_result.calculate_metrics(simulated_top_k_reader=3, document_relevance_criterion="id")
...
def test_extractive_qa_eval_simulated_top_k_retriever(reader, retriever_with_docs):
    ...
    metrics_top_10 = eval_result.calculate_metrics(document_relevance_criterion="id")
    ...
    metrics_top_1 = eval_result.calculate_metrics(simulated_top_k_retriever=1, document_relevance_criterion="id")
    ...
    metrics_top_2 = eval_result.calculate_metrics(simulated_top_k_retriever=2, document_relevance_criterion="id")
    ...
    metrics_top_3 = eval_result.calculate_metrics(simulated_top_k_retriever=3, document_relevance_criterion="id")
...
def test_extractive_qa_eval_simulated_top_k_reader_and_retriever(reader, retriever_with_docs):
    ...
    metrics_top_10 = eval_result.calculate_metrics(simulated_top_k_reader=1, document_relevance_criterion="id")
    ...
    metrics_top_1 = eval_result.calculate_metrics(
        simulated_top_k_reader=1, simulated_top_k_retriever=1, document_relevance_criterion="id"
    )
    ...
    metrics_top_2 = eval_result.calculate_metrics(
        simulated_top_k_reader=1, simulated_top_k_retriever=2, document_relevance_criterion="id"
    )
    ...
    metrics_top_3 = eval_result.calculate_metrics(
        simulated_top_k_reader=1, simulated_top_k_retriever=3, document_relevance_criterion="id"
    )
