...
from haystack.retriever.dense import DensePassageRetriever, EmbeddingRetriever, MultimodalRetriever
...
@pytest.fixture(params=["es_filter_only", "elasticsearch", "dpr", "embedding", "tfidf", "mm_retriever"])
...
def get_retriever(retriever_type, document_store):
    ...
    elif retriever_type == "mm_retriever":
        retriever = MultimodalRetriever(document_store=document_store,
