...
def get_document_store(document_store_type, embedding_dim=768, embedding_field="embedding", similarity:str="dot_product"):
    if document_store_type == "sql":
        ...
        document_store = InMemoryDocumentStore(
            return_embedding=True, embedding_dim=embedding_dim, embedding_field=embedding_field, index="haystack_test", similarity=similarity
        )
        ...
        document_store = ElasticsearchDocumentStore(
            index="haystack_test", return_embedding=True, embedding_dim=embedding_dim, embedding_field=embedding_field, similarity=similarity
        )
