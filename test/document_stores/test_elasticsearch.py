...
class ElasticsearchDocumentStoreTestAbstract(DocumentStoreBaseTestAbstract, SearchEngineDocumentStoreTestAbstract):
    """
    Tests both elasticsearch7.ElasticsearchDocumentStore and elasticsearch8.ElasticsearchDocumentStore depending on the
    version of the installed elasticsearch package.
    """
    ...
    @pytest.mark.unit
    @pytest.mark.skipif(ES_VERSION[0] != 7, reason="aws4auth only supported in ES7.")
    ...
    @pytest.mark.unit
    @pytest.mark.skipif(ES_VERSION[0] != 7, reason="Only run for ES7")
    def test_import_from_haystack_document_stores_es7(self):
        from haystack.document_stores import ElasticsearchDocumentStore
