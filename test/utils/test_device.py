...
def test_device_cuda(torch_cuda_is_available):
...
@patch("torch.cuda.is_available")
def test_device_mps(torch_cuda_is_available, torch_backends_mps_is_available):
...
@patch("torch.backends.mps.is_available")
@patch("torch.cuda.is_available")
def test_device_cpu(torch_cuda_is_available, torch_backends_mps_is_available):
    torch_cuda_is_available.return_value = False
